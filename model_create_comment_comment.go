...
// checks if the CreateCommentComment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateCommentComment{}
...
func (o CreateCommentComment) MarshalJSON() ([]byte, error) {
...
func (o CreateCommentComment) ToMap() (map[string]interface{}, error) {
...
type NullableCreateCommentComment struct {
	value *CreateCommentComment
	isSet bool
}

func (v NullableCreateCommentComment) Get() *CreateCommentComment {
	return v.value
}

func (v *NullableCreateCommentComment) Set(val *CreateCommentComment) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateCommentComment) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateCommentComment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateCommentComment(val *CreateCommentComment) *NullableCreateCommentComment {
	return &NullableCreateCommentComment{value: val, isSet: true}
}

func (v NullableCreateCommentComment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateCommentComment) UnmarshalJSON(src []byte) error {
	v.isSet = true
