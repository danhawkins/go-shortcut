...
// checks if the StorySearchResults type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorySearchResults{}
...
func (o StorySearchResults) MarshalJSON() ([]byte, error) {
...
func (o StorySearchResults) ToMap() (map[string]interface{}, error) {
...
type NullableStorySearchResults struct {
	value *StorySearchResults
	isSet bool
}

func (v NullableStorySearchResults) Get() *StorySearchResults {
	return v.value
}

func (v *NullableStorySearchResults) Set(val *StorySearchResults) {
	v.value = val
	v.isSet = true
}

func (v NullableStorySearchResults) IsSet() bool {
	return v.isSet
}

func (v *NullableStorySearchResults) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorySearchResults(val *StorySearchResults) *NullableStorySearchResults {
	return &NullableStorySearchResults{value: val, isSet: true}
}

func (v NullableStorySearchResults) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorySearchResults) UnmarshalJSON(src []byte) error {
	v.isSet = true
