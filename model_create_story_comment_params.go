...
// checks if the CreateStoryCommentParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateStoryCommentParams{}
...
func (o *CreateStoryCommentParams) SetParentIdNil() {
	o.ParentId.Set(nil)
}
...
func (o CreateStoryCommentParams) MarshalJSON() ([]byte, error) {
...
func (o CreateStoryCommentParams) ToMap() (map[string]interface{}, error) {
...
type NullableCreateStoryCommentParams struct {
	value *CreateStoryCommentParams
	isSet bool
}

func (v NullableCreateStoryCommentParams) Get() *CreateStoryCommentParams {
	return v.value
}

func (v *NullableCreateStoryCommentParams) Set(val *CreateStoryCommentParams) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateStoryCommentParams) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateStoryCommentParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateStoryCommentParams(val *CreateStoryCommentParams) *NullableCreateStoryCommentParams {
	return &NullableCreateStoryCommentParams{value: val, isSet: true}
}

func (v NullableCreateStoryCommentParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateStoryCommentParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
