...
// checks if the EpicSearchResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EpicSearchResult{}
...
// SetComments gets a reference to the given []ThreadedComment and assigns it to the Comments field.
...
func (o EpicSearchResult) MarshalJSON() ([]byte, error) {
...
func (o EpicSearchResult) ToMap() (map[string]interface{}, error) {
...
type NullableEpicSearchResult struct {
	value *EpicSearchResult
	isSet bool
}

func (v NullableEpicSearchResult) Get() *EpicSearchResult {
	return v.value
}

func (v *NullableEpicSearchResult) Set(val *EpicSearchResult) {
	v.value = val
	v.isSet = true
}

func (v NullableEpicSearchResult) IsSet() bool {
	return v.isSet
}

func (v *NullableEpicSearchResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEpicSearchResult(val *EpicSearchResult) *NullableEpicSearchResult {
	return &NullableEpicSearchResult{value: val, isSet: true}
}

func (v NullableEpicSearchResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEpicSearchResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
